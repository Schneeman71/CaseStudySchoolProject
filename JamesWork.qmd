...
ggplot(df, aes(x = RET_FT4, y = C150_4, color = minority_women)) +
  ...
  scale_color_gradient(low = "#FDD49E", high = "#D7301F", name = "Minority Women\nProportion") +
  labs(
    title = "Retention Programs Are More Effective at Minority-Inclusive Institutions",
    subtitle = "Higher proportion of minority women increases the positive effect of retention on graduation",
